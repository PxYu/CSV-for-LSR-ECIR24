...
from .json_preprocessor import Json_TrainPreProcessor, Json_QueryPreProcessor, Json_CorpusPreProcessor
from ..arguments import DataArguments

DEFAULT_PROCESSORS = [TrainPreProcessor, QueryPreProcessor, CorpusPreProcessor]
JSON_PROCESSORS = [Json_TrainPreProcessor, Json_QueryPreProcessor, Json_CorpusPreProcessor]
PROCESSOR_INFO = {
...
class HFQueryDataset:
    def __init__(self, tokenizer: PreTrainedTokenizer, data_args: DataArguments, cache_dir: str):
        ...
        self.dataset = load_dataset(data_args.dataset_name,
                                    data_args.dataset_language,
                                    data_files=data_files, cache_dir=cache_dir)["dev"]
