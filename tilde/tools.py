...
def get_stop_ids(tok):
    ...
    return set(stop_ids), set(garbage_ids)


## stop_ids means ignoring most stopwords, numbers

## for a not-so-good BERT model, 
## putting tokens into stop_ids is more likely to encourage generating it
